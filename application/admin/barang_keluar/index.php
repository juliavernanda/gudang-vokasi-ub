                    ...
                    <div class="card-header card-header-info card-header-icon">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2 col-6">
                                <a type="button" href="./admin/barang_keluar/export_excel.php" class="btn btn-info padding-10" target="_blank" id="btnAddNew" style="float: right;">
                                  Export Excel
                                </a>
                            ...
                            <table id="dataList" class="table table-striped table-no-bordered table-hover dataTables" cellspacing="0" width="100%" style="width:100%">
                                ...
                                while ($row=mysqli_fetch_assoc($result))
                                {
                                    ...
                                    echo '<td class="td-actions text-center">
                                              ...
                                              <a href="./controller/delete.php?table=t_barang_keluar&id='.$id.'">
