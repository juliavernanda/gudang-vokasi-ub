        ...
        <form id="formBarangMasuk" action="" enctype="multipart/form-data" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="my-modal-history"><b> Tambah Data Barang Keluar </b></h3>
...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO t_barang_keluar(id_barang,jumlah,tanggal) VALUES('$txtIdBarang','$txtJumlah','$txtDate')");
}else if(isset($_POST['Update'])){
    $id = $_POST['hdID'];
    $txtIdBarang = $_POST['txtIdBarang'];
    $txtJumlah = $_POST['txtJumlah'];
    $txtDate = $_POST['txtDate'];
    $result = mysqli_query($conn, "UPDATE t_barang_keluar SET id_barang='$txtIdBarang',jumlah='$txtJumlah',tanggal='$txtDate' WHERE id=$id");
}
?>